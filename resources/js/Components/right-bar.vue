...
export default {
    ...
    computed: {
        ...
        preloader: {
            get() {
                return this.$store
                    ? this.$store.state.layout.preloader
                    : {} || {}
            },
            set(preloader) {
        ...
        position: {
            get() {
                return this.$store
                    ? this.$store.state.layout.position
                    : {} || {}
            },
            set(position) {
        ...
        sidebarView: {
            get() {
                return this.$store
                    ? this.$store.state.layout.sidebarView
                    : {} || {}
            },
            set(sidebarView) {
        ...
        sidebarImage: {
            get() {
                return this.$store
                    ? this.$store.state.layout.sidebarImage
                    : {} || {}
            },
            set(sidebarImage) {
        ...
        visibility: {
            get() {
                return this.$store
                    ? this.$store.state.layout.visibility
                    : {} || {}
            },
            set(visibility) {
...
<template>
    <div>
        ...
        <BOffcanvas
            ...
            header-class="d-flex align-items-center bg-secondary bg-gradient p-3"
            body-class="p-0"
            z-index="1005"
        ...
        >
            <template #header>
                <div class="me-2">
                    <h5 class="m-0 me-2 text-white">Custom Theme</h5>
                </div>
                <button
                    type="button"
